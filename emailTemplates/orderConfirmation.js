...
async function getOrderConfirmationTemplate(orderData, locale = "de") {
  try {
    ...
    const formattedDate = orderDate.toLocaleDateString(dateLocale, {
      weekday: "long",
      year: "numeric",
      month: "long",
      day: "numeric",
    });
    const formattedTime = orderDate.toLocaleTimeString(dateLocale, {
      hour: "2-digit",
      minute: "2-digit",
    });
...
<html dir="ltr" xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="de">
  ...
  ${getEmailHead(i18n.t("orderEmail.subject"))}
...
<body class="body"
        ...
        <table width="100%" cellspacing="0" cellpadding="0" class="es-wrapper" role="none"
            ...
            <tr>
                <td valign="top" style="padding:0;Margin:0">
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        ${i18n.t("orderEmail.greeting", { patientName: orderData.patientName || "" })}</p>
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        <br>
                                                                    </p>
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        ${i18n.t("orderEmail.confirmation")}</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td align="left" style="padding:20px">
                                                                                <p style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:16px;font-weight:bold;color:#333333">
                                                                                    ${i18n.t("orderEmail.detailsTitle")}
                                                                                </p>
                                                                                <br>
                                                                                <table width="100%" cellpadding="5" cellspacing="0" style="font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:14px;color:#333333">
                                                                                    <tr>
                                                                                        <td style="padding:8px 0;border-bottom:1px solid #e0e0e0"><strong>${i18n.t("orderEmail.orderNumber")}</strong></td>
                                                                                        <td style="padding:8px 0;border-bottom:1px solid #e0e0e0">${orderData.orderNumber || orderData._id}</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td style="padding:8px 0;border-bottom:1px solid #e0e0e0"><strong>${i18n.t("orderEmail.orderDate")}</strong></td>
                                                                                        <td style="padding:8px 0;border-bottom:1px solid #e0e0e0">${formattedDate}, ${formattedTime}</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td style="padding:8px 0;border-bottom:1px solid #e0e0e0"><strong>${i18n.t("orderEmail.orderType")}</strong></td>
                                                                                        <td style="padding:8px 0;border-bottom:1px solid #e0e0e0">${orderData.orderType || ""}</td>
                                                                                    </tr>
                                                                                    ${
                                                                                      orderData.description
                                                                                        ? `
                                                                                    <tr>
                                                                                        <td style="padding:8px 0"><strong>${i18n.t("orderEmail.description")}</strong></td>
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        ${i18n.t("orderEmail.processing")}</p>
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        <br>
                                                                    </p>
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        ${i18n.t("orderEmail.notification")}</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        <strong>${i18n.t("orderEmail.importantTitle")}</strong>
                                                                    </p>
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        <br>
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        ${i18n.t("orderEmail.regards")}
                                                                    </p>
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        <br>
                                                                        <strong>${i18n.t("orderEmail.practiceName")}</strong><br>
                                                                        ${i18n.t("orderEmail.address")}
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                   ...
                   ${getEmailFooter(i18n.t("orderEmail.footer", { year: currentYear }))}
                </td>
            </tr>
        </table>
    </div>
    ...
    console.error("Error generating order confirmation email template:", error);
    throw error;
  }
}
